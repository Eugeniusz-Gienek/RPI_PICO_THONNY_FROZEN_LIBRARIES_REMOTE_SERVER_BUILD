...
echo [INFO] [%date% %time%] Executing remote script "%remote_server_upload_script%" with this list of files: "%files%"
ssh %remote_server_user%@%remote_server_url% %remote_server_upload_script% %files%
